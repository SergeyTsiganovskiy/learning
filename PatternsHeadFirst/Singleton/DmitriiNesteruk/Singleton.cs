...
namespace PatternsHeadFirst.Singleton.DmitriiNesteruk
{
    ...
    {
        private Dictionary<char, int> capitals;
        ...
        private SingletonDatabase()
        {
            ...
            capitals = File.ReadAllLines(
              Path.Combine(
                ...
                list => int.Parse(char.ToString(list.ElementAt(1))));
        }

        public int GetPopulation(string name)
        {
            return 'q'; //capitals[name]; temp solut for building
        }
